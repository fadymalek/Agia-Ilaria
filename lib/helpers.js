...
// تسلسل JSON آمن للحقن داخل <script> — يمنع الهروب عبر </script> أو فواصل الأسطر
const RE_LT = /</g;
const RE_GT = />/g;
const RE_AMP = /&/g;
...
module.exports = { TYPES, VALID_TYPES, typeInfo, isStayType, cairoToday, bookingDate, bookingWhen, waLink, findConflictIds, safeJson };
